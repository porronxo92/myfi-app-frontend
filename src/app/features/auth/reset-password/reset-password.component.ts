      ...
      <div class="form-section">
        ...
        <div class="form-container">
          ...
          <div *ngIf="verifying()" class="verifying-state">
            <svg class="spinner spinner-lg" width="48" height="48" viewBox="0 0 24 24" fill="none">
          ...
          <div *ngIf="tokenInvalid()" class="invalid-token-state">
            ...
            <a routerLink="/forgot-password" class="submit-button">
            ...
            <form [formGroup]="resetForm" (ngSubmit)="onSubmit()" class="reset-form">
              ...
              <div class="form-group">
                ...
                <div class="error-message" *ngIf="resetForm.get('password')?.invalid && resetForm.get('password')?.touched">
                  ...
                  <span *ngIf="resetForm.get('password')?.errors?.['minlength']">Mínimo 8 caracteres</span>
                  <span *ngIf="resetForm.get('password')?.errors?.['pattern']">Debe tener mayúscula, minúscula y número</span>
                </div>
              ...
              <button
                type="submit"
                class="submit-button"
                [disabled]="resetForm.invalid || loading() || passwordMismatch() || !!successMessage()"
              >
...
export class ResetPasswordComponent implements OnInit {
  ...
  passwordMismatch(): boolean {
    ...
    const confirmTouched = this.resetForm.get('confirmPassword')?.touched;
    return confirmTouched && confirm && password !== confirm;
  }
  ...
  onSubmit(): void {
    ...
    this.authService.resetPassword(this.token, this.resetForm.value.password).subscribe({
      next: () => {
        this.successMessage.set('Contraseña actualizada correctamente. Redirigiendo al inicio de sesión...');
      ...
      error: (error) => {
        this.errorMessage.set(error.message || 'Error al actualizar la contraseña. El enlace puede haber expirado.');
        this.loading.set(false);
      }
    });
  }
